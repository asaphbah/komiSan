        ...
        <div class="report-table">
            <table>
                <thead>
                    ...
                    <th>usuario reportado<br>(username)</th>
                    <th>Motivo de report</th>
                    <th></th>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <th>
                            <a href="{{route('profile.komisan',['username' => $report->reportingUser->username])}}">{{$report->reportingUser->name}}</a>
                        </th>
                        <th>
                            <a href="{{route('profile.komisan',['username' => $report->reportedUser->username])}}">{{$report->reportedUser->username}}</a>
                        </th>
                        <th>
                            {{$report->report_text}}
                        </th>
